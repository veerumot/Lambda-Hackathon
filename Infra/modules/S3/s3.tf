...
resource "aws_s3_object" "data" {
  ...
  source = "/Users/madhurigorantla/github/Lambda-Hackthon/bot/bot_data.json"  # Replace with the path to your local file
  etag   = filemd5("/Users/madhurigorantla/github/Lambda-Hackthon/bot/bot_data.json") # Optional: ETag for object versioning
}
